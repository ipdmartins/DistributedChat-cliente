...
public class ClientScreen extends JFrame {
	...
	private JPanel panelUsersMap;
	private HashMap<JRadioButton, JLabel> mapa;
	private JRadioButton novoRadio;
	private JLabel novaLabel;
	...
	private void initComponents() {
		...
		mapa = new HashMap<JRadioButton, JLabel>();
		...
		// BUTTONS
		jbAddMyList = new JButton("Add to MyList");
        ...
        chatPrincipal.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 1) {
                	clienteControl.pegarIndexTabuleiro (chatPrincipal.getSelectedRow(), chatPrincipal.getSelectedColumn());
	...
	private void panelMyAccount() {
		...
		jbSave.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				String s = clienteControl.register(jtxtName.getText(), jtxtEmailAccount.getText(), jtxtBirth.getText(), jtxtPassword.getText(), 
						jtxtMyPort.getText(), jtxtMyIp.getText(), jtxtServerPort.getText(), jtxtServerIP.getText());
				optionPane.showMessageDialog(null, s);
